    ...
    render() {
        ...
        return (
            <div className="mid container">
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">BATCH 18</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS & EE</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">BATCH 19</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS & EE</h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">BATCH 20</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS & EE</h6>
                            <p onClick={() => this.onBatchSelect('2020')} className="card-text" style={{
                                cursor: 'pointer',
                                color: '#00a4eb'
                            }}>Add or Check Info</p>
                        </div>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">BATCH 21</h5>
                            <h6 className="card-subtitle mb-2 text-muted">CS & EE</h6>
                ...
                <br />
                <label htmlFor="find" style={{ marginLeft: '14px' }}><h3>Find Student</h3></label>
